...
std::istream &getline(std::istream &input, std::string &str, std::string _delim)
{
    str.erase();
    char ch;
    while (input >> ch and str.length() < str.max_size())
    {
...
{
    return iequals(blood, std::string("ABP")) or iequals(blood, std::string("ABN")) or iequals(blood, std::string("AP")) or iequals(blood, std::string("AN")) or iequals(blood, std::string("BP")) or iequals(blood, std::string("BN")) or iequals(blood, std::string("OP")) or iequals(blood, std::string("ON"));
}
